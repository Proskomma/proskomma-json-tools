...
const { identityActions } = require('../../dist/render/sofriaToSofria/renderActions/identity');
...
const usfm = fse.readFileSync(path.resolve(path.join('./', 'test_data', 'usfms', 'table.usfm'))).toString();
